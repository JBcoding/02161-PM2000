...
public class ProjectTest {
    ...
    public void TestProject_Constructor_NoNullName() {
        try {
            Project project = new Project(null, "ProjectID");
    ...
    @Test
    public void TestProject_Constructor_NoNullID() {
        try {
            Project project = new Project("Project name", null);

            fail("Project allows null ID");
        } catch (NullPointerException e) {
